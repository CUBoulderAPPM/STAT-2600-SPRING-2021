...
nlsy <- read_csv("https://www.colorado.edu/amath/sites/default/files/attached-files/nlsy97_nov2020.txt
")
```

#### Variables present in the base data set

To learn more about the data, you can have a look at the [variable codebook file](https://www.colorado.edu/amath/sites/default/files/attached-files/final_project_code_book.txt
).
